...
# load the data
# load("src/stat133/assignments/hw2")
...
plot(wr1500m$new_year,wr1500m$times_sec)
...
# plot( your code here )
plot(wr1500m$new_year, wr1500m$times_sec, xlim = c(min(wr1500m$new_year), max(wr1500m$new_year) + 17))
...
# abline( your code here )
# text( your code here )
text(x=wr_1944, y=wr1500m$times_sec[wr1500m$new_year == wr_1944], wr1500m$athlete[wr1500m$new_year == wr_1944],
     adj = 1, cex = 1, col ="green")
# text( your code here )
text(x=wr_1998, y=wr1500m$times_sec[wr1500m$new_year == wr_1998], wr1500m$athlete[wr1500m$new_year == wr_1998],
     adj = 1, cex = 1, col="red")
...
plot(wr1500m$new_year, wr1500m$times_sec, xlim = c(min(wr1500m$new_year), 
  ylim = max(wr1500m$new_year) + 17), xlab = "Date", ylab = "World Record in seconds" , main = "Men's 1500m Record Times")
abline(v = wr_1944 , col = "grey")
abline(v = wr_1998, col = "grey")
text(x=wr_1944, y=wr1500m$times_sec[wr1500m$new_year == wr_1944], wr1500m$athlete[wr1500m$new_year == wr_1944],
     adj = 1, cex = 1, col ="green")
...
symbols(x = log(SO2012Ctry$GDP_per_person), y =log(SO2012Ctry$pop), circles = log(SO2012Ctry$Total)/25, inches = FALSE)
...
symbols(x = log(SO2012Ctry$GDP_per_person), y =log(SO2012Ctry$pop), circles = log(SO2012Ctry$Total)/25, inches = FALSE, 
        xlab = "log of GDP Per Capita", ylab = "log of Population", main = "Medal Count in relation to Population and GDP Per Capita")
...
world = map(database = "world", fill = TRUE, col = "light grey")
# symbols( your code here )
symbols(wonMetal$longitude, wonMetal$latitude, circles= log(wonMetal$Total)/2, add = TRUE, inches = FALSE, bg = "blue")
...
world <- map(database = "world", fill = TRUE, col = "light grey")
# symbols( your code here )
symbols(wonMetal$longitude, wonMetal$latitude, circles = log(wonMetal$Total)/2, add = TRUE, inches = FALSE, bg = myGold)
...
barplot(athTab2[ , orderSport], beside = TRUE, las = 3, cex.names = 1, ylim = c(0,1600),
        main = "Gender in the Olympics")
